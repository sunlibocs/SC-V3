...
parser.add_argument('--dataset', type=str, choices=['kitti', 'nyu', 'scannet'], default='kitti', help='the dataset to train')
...
def load_tensor_image(filename, args):
    ...
    #     scaled_image = imresize(cropped_image, (args.img_height, args.img_width)).astype(np.float32) 
    #     img = scaled_image
    # else:
