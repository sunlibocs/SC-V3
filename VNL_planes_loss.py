...
class VNL_Planes_Loss(nn.Module):
    """
    ...
    def __init__(self, focal_x, focal_y, input_size,
        ...
        """
        super(VNL_Planes_Loss, self).__init__()
    ...
    def forward(self, gt_depth, pred_depth, mask, focal_length_x, focal_length_y, u0, v0):
        """
        Virtual normal loss.
        ...
        for i in range(B):
            ...
            self.fx = focal_length_x[i]
            self.fy = focal_length_y[i]
...
if __name__ == '__main__':
    import cv2
    vnl_loss = VNL_Planes_Loss(500.0, 500.0, (385, 513), xyz_mode='uvd')
